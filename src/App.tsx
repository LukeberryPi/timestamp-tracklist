  ...
  const handleDrop = async (e: React.DragEvent) => {
    ...
    if (droppedFile && isCueFile(droppedFile)) {
      try {
        ...
        setFile(droppedFile);
        sonner({
          title: "Cue file loaded",
          description: `${droppedFile.name} has been loaded successfully.`,
        });
      } catch (err) {
        sonner({
          title: "Error",
          description: "Failed to read the cue file.",
          variant: "destructive",
        });
      }
    } else {
      sonner({
        title: "Invalid file",
        description: "Please upload a .cue file only.",
        variant: "destructive",
      });
    }
  };
            ...
            <div className="space-y-4">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  <AccordionTrigger isQuestion>Intro Offset</AccordionTrigger>
                  <AccordionContent>
          ...
          <div className="space-y-4">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  If you made a video where you introduced yourself for 15
                  seconds and then pressed play, use 15 as the offset value. The
                  timestamps for all tracks will be adjusted +15 seconds.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
            <div className="flex items-center gap-4">
